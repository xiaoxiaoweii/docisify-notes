!(function () {
	...
	var P,
		...
		D = (function t(e) {
			...
			if (((d.version = '2.0.8'), (d.removed = []), !c || !c.document || 9 !== c.document.nodeType))
			...
			function L(e) {
				(pe && pe === e) ||
					...
					(D = 'ALLOWED_TAGS' in e ? ze({}, e.ALLOWED_TAGS) : H),
					(q = 'ALLOWED_ATTR' in e ? ze({}, e.ALLOWED_ATTR) : I),
					(ce = 'ADD_URI_SAFE_ATTR' in e ? ze(Pe(ue), e.ADD_URI_SAFE_ATTR) : ue),
					(U = 'FORBID_TAGS' in e ? ze({}, e.FORBID_TAGS) : {}),
					(B = 'FORBID_ATTR' in e ? ze({}, e.FORBID_ATTR) : {}),
					(oe = 'USE_PROFILES' in e && e.USE_PROFILES),
					(Z = !1 !== e.ALLOW_ARIA_ATTR),
					(W = !1 !== e.ALLOW_DATA_ATTR),
					(G = e.ALLOW_UNKNOWN_PROTOCOLS || !1),
					(Y = e.SAFE_FOR_JQUERY || !1),
					...
					(ie = !1 !== e.KEEP_CONTENT),
					(ae = e.IN_PLACE || !1),
					(j = e.ALLOWED_URI_REGEXP || j),
					V && (W = !1),
					ee && (J = !0),
					oe &&
						((D = ze({}, [].concat(tt(Ie)))),
						(q = []),
						!0 === oe.html && (ze(D, je), ze(q, Ue)),
						!0 === oe.svg && (ze(D, De), ze(q, Be), ze(q, We)),
						!0 === oe.svgFilters && (ze(D, He), ze(q, Be), ze(q, We)),
						!0 === oe.mathMl && (ze(D, qe), ze(q, Ze), ze(q, We))),
					e.ADD_TAGS && (D === H && (D = Pe(D)), ze(D, e.ADD_TAGS)),
					e.ADD_ATTR && (q === I && (q = Pe(q)), ze(q, e.ADD_ATTR)),
					e.ADD_URI_SAFE_ATTR && ze(ce, e.ADD_URI_SAFE_ATTR),
					ie && (D['#text'] = !0),
					X && ze(D, ['html', 'head', 'body']),
					D.table && (ze(D, ['tbody']), delete U.tbody),
					xe && xe(e),
					(pe = e));
			}
			function C(t) {
			...
			function F(e) {
				...
				return (
					e && n && t.body.insertBefore(l.createTextNode(n), t.body.childNodes[0] || null),
					A.call(t, X ? 'html' : 'body')[0]
				);
			}
			var O = Ge,
				$ = Ye,
			...
			d.isSupported &&
				((function () {
					try {
						F('<svg><p><textarea><img src="</textarea><img src=x abc=1//">').querySelector('svg img') &&
							(o = !0);
					} catch (e) {}
				})(),
				(function () {
			...
			function fe(e) {
				return 'object' === (void 0 === h ? 'undefined' : et(h))
					? e instanceof h
					: e &&
			...
			function me(e) {
				...
				var n = Le(e.nodeName);
				if (
					(ge('uponSanitizeElement', e, { tagName: n, allowedTags: D }),
					('svg' === n || 'math' === n) && 0 !== e.querySelectorAll('p, br').length)
				)
					return C(e), !0;
				if (D[n] && !U[n])
					return 'noscript' === n && $e(/<\/noscript/i, e.innerHTML)
						? (C(e), !0)
						: 'noembed' === n && $e(/<\/noembed/i, e.innerHTML)
						? (C(e), !0)
						: (!Y ||
								e.firstElementChild ||
								...
								e.innerHTML
									? (e.innerHTML = Re(e.innerHTML, /</g, '&lt;'))
									: (e.innerHTML = Re(e.textContent, /</g, '&lt;'))),
						  V &&
								3 === e.nodeType &&
								((t = e.textContent),
								(t = Re(t, O, ' ')),
								(t = Re(t, $, ' ')),
								e.textContent !== t &&
									(Te(d.removed, { element: e.cloneNode() }), (e.textContent = t))),
			...
			function be(e) {
				...
				for (ge('beforeSanitizeShadowDOM', e, null); (t = n.nextNode()); )
					ge('uponSanitizeShadowNode', t, null), me(t) || (t.content instanceof p && be(t.content), ye(t));
			...
			return (
				(d.sanitize = function (e, t) {
					...
					if ((K || L(t), (d.removed = []), 'string' == typeof e && (ae = !1), ae));
						...
						1 === (r = (n = F('\x3c!--\x3e')).ownerDocument.importNode(e, !0)).nodeType &&
						'BODY' === r.nodeName
							? (n = r)
							: 'HTML' === r.nodeName
							? (n = r)
					...
					n && Q && C(n.firstChild);
					for (var s = he(ae ? e : n); (i = s.nextNode()); )
						(3 === i.nodeType && i === a) ||
							me(i) ||
							(i.content instanceof p && be(i.content), ye(i), (a = i));
					if (((a = null), ae)) return e;
					if (J) {
						if (ee) for (o = S.call(n.ownerDocument); n.firstChild; ) o.appendChild(n.firstChild);
						else o = n;
		...
		!(function () {
			...
			function l(e) {
				(this.tokens = []),
					...
					(this.rules = b.normal),
					this.options.pedantic ? (this.rules = b.pedantic) : this.options.gfm && (this.rules = b.gfm);
			}
			(b._label = /(?!\s*\])(?:\\[\[\]]|[^\[\]])+/),
				(b._title = /(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/),
				(b.def = e(b.def).replace('label', b._label).replace('title', b._title).getRegex()),
				(b.bullet = /(?:[*+-]|\d{1,9}\.)/),
				(b.item = /^( *)(bull) ?[^\n]*(?:\n(?!\1bull ?)[^\n]*)*/),
				(b.item = e(b.item, 'gm').replace(/bull/g, b.bullet).getRegex()),
				(b.list = e(b.list)
				...
				(b.paragraph = e(b._paragraph)
					...
					.replace('tag', b._tag)
					.getRegex()),
				(b.blockquote = e(b.blockquote).replace('paragraph', b.paragraph).getRegex()),
				(b.normal = h({}, b)),
				(b.gfm = h({}, b.normal, {
					nptable: /^ *([^|\n ].*\|.*)\n *([-:]+ *\|[-| :]*)(?:\n((?:.*[^>\n ].*(?:\n|$))*)\n*|$)/,
					table: /^ *\|(.+)\n *\|?( *[-:]+[-| :]*)(?:\n((?: *[^>\n ].*(?:\n|$))*)\n*|$)/,
				...
				(b.pedantic = h({}, b.normal, {
					...
					heading: /^ *(#{1,6}) *([^\n]+?) *(?:#+ *)?(?:\n+|$)/,
					fences: p,
					paragraph: e(b.normal._paragraph)
						.replace('hr', b.hr)
						.replace('heading', ' *#{1,6} *[^\n]')
				...
				(l.prototype.token = function (e, t) {
					...
					for (e = e.replace(/^ +$/gm, ''); e; )
						if (
							...
							for (e = e.substring(i[0].length), d = 0; d < s.align.length; d++)
								/^ *-+: *$/.test(s.align[d])
									? (s.align[d] = 'right')
									: /^ *:-+: *$/.test(s.align[d])
									? (s.align[d] = 'center')
							...
							for (
								...
								(p = (s = i[d]).length),
									...
									d !== f - 1 &&
										((o = b.bullet.exec(i[d + 1])[0]),
										(1 < a.length
											? 1 === o.length
											: 1 < o.length || (this.options.smartLists && o !== a)) &&
											((e = i.slice(d + 1).join('\n') + e), (d = f - 1))),
									(r = n || /\n\n(?!\s*$)/.test(s)),
									...
									(u = { type: 'list_item_start', task: m, checked: v, loose: r }),
									c.push(u),
									this.tokens.push(u),
									this.token(s, !1),
							...
							for (d = 0; d < s.cells.length; d++)
								s.cells[d] = x(s.cells[d].replace(/^ *\| *| *\| *$/g, ''), s.header.length);
							this.tokens.push(s);
			...
			(n._punctuation = '!"#$%&\'()*+,\\-./:;<=>?@\\[^_{|}~'),
				...
				(n.tag = e(n.tag).replace('comment', b._comment).replace('attribute', n._attribute).getRegex()),
				(n._label = /(?:\[[^\[\]]*\]|\\.|`[^`]*`|[^\[\]\\`])*?/),
				(n._href = /<(?:\\[<>]?|[^\s<>\\])*>|[^\s\x00-\x1f]*/),
				(n._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/),
				(n.link = e(n.link)
					...
					for (var t, n, r, i, a, o, s = ''; e; )
						if ((a = this.rules.escape.exec(e))) (e = e.substring(a[0].length)), (s += k(a[1]));
							...
							(e = e.substring(a[0].length)),
								...
								(s += this.outputLink(a, { href: u.escapes(r), title: u.escapes(i) })),
								(this.inLink = !1);
							...
							(e = e.substring(a[0].length)), (s += this.renderer.codespan(k(a[2].trim(), !0)));
						else if ((a = this.rules.br.exec(e))) (e = e.substring(a[0].length)), (s += this.renderer.br());
						else if ((a = this.rules.del.exec(e)))
							(e = e.substring(a[0].length)), (s += this.renderer.del(this.output(a[1])));
							...
							if ((a = this.rules.text.exec(e)))
								(e = e.substring(a[0].length)),
									this.inRawBlock
										...
										: (s += this.renderer.text(k(this.smartypants(a[0]))));
							else if (e) throw new Error('Infinite loop on byte: ' + e.charCodeAt(0));
						} else {
				...
				(c.prototype.parse = function (e) {
					(this.inline = new u(e.links, this.options)),
						(this.inlineText = new u(e.links, h({}, this.options, { renderer: new i() }))),
					...
					switch (this.token.type) {
						...
						case 'list_item_start':
							...
							for (
								...
								a += l || 'text' !== this.token.type ? this.tok() : this.parseText();
				...
				if (r || 'function' == typeof n) {
					...
					try {
						...
						if (
							...
							return '<p>An error occurred:</p><pre>' + k(e.message + '', !0) + '</pre>';
						throw e;
					}
			}
			(p.exec = p),
	...
	var mt,
		vt = at(function (e) {
				...
				var u = /\blang(?:uage)?-([\w-]+)\b/i,
					...
					F = {
						...
						util: {
							encode: function (e) {
								return e instanceof O
									? new O(e.type, F.util.encode(e.content), e.alias)
									: Array.isArray(e)
									? e.map(F.util.encode)
									: e
											.replace(/&/g, '&amp;')
								...
								for (var o in t)
									if (t.hasOwnProperty(o)) {
										...
										var s = t[o],
											l = F.util.type(s);
										'Object' !== l || i[a(s)]
											? 'Array' !== l || i[a(s)] || ((i[a(s)] = !0), e(s, n, o, i))
						...
						highlightAllUnder: function (e, t, n) {
							...
							F.hooks.run('before-highlightall', r),
								(r.elements = Array.prototype.slice.apply(r.container.querySelectorAll(r.selector))),
								F.hooks.run('before-all-elements-highlight', r);
						...
						highlightElement: function (e, t, n) {
							...
							a &&
								...
								(a.className = a.className.replace(u, '').replace(/\s+/g, ' ') + ' language-' + r);
							...
							if ((F.hooks.run('before-sanity-check', o), !o.code))
								return F.hooks.run('complete', o), void (n && n.call(o.element));
						...
						highlight: function (e, t, n) {
							...
							return (
								F.hooks.run('before-tokenize', r),
								(r.tokens = F.tokenize(r.code, r.grammar)),
								F.hooks.run('after-tokenize', r),
								O.stringify(F.util.encode(r.tokens), r.language)
							);
						},
										...
										for (var v = r, y = i; v < t.length; y += t[v].length, ++v) {
											...
											if (!(b instanceof O)) {
												if (h && v != t.length - 1) {
													...
													for (
														var k = S.index + (d && S[1] ? S[1].length : 0),
															x = S.index + S[0].length,
															w = v,
															_ = y,
															A = t.length;
														w < A && (_ < x || (!t[w].type && !t[w - 1].greedy));
														++w
													)
														(_ += t[w].length) <= k && (++v, (y = _));
												...
												if (S) {
													...
													if (
														...
														1 != T && F.matchGrammar(e, t, n, v, y, !0, s + ',' + c),
														a)
													)
														break;
												} else if (a) break;
			...
			e.exports && (e.exports = c),
				...
				(c.languages.markup.tag.inside['attr-value'].inside.entity = c.languages.markup.entity),
	...
	(mt = Prism),
		Object.defineProperties((mt.languages['markup-templating'] = {}), {
			buildPlaceholders: {
	...
	var bt = {},
		...
		xt = function (i, e) {
			...
			var n = i.markdown || {};
			(o = r(n) ? n(ot, t) : (ot.setOptions(h(n, { renderer: h(t, n.renderer) })), ot)),
				(this._marked = o),
								  ...
								  (t = i.noEmoji
										...
										: (function (e) {
												return e
													...
													.replace(/:(\w+?):/gi, window.emojify || ft)
													.replace(/__colon__/g, ':');
										  })(t)),
								  ht.clear(),
								  t)
	...
	(xt.prototype.compileEmbed = function (e, t) {
		...
		if (((t = i), a.include)) {
			var o;
			if ((Q(e) || (e = re(this.contentBase, ee(this.router.getCurrentPath()), e)), a.type && (o = kt[a.type])))
		...
		(xt.prototype._initRenderer = function () {
			...
			return (
				...
				(i.code = (function (e) {
					return (e.renderer.code = function (e, t) {
						...
						return (
							...
							t +
							'">' +
							vt.highlight(e.replace(/@DOCSIFY_QM@/g, '`'), n) +
							'</code></pre>'
						);
					});
				})({ renderer: e })),
						...
						return (
							...
							Q(e) || u._matchNotCompileLink(e) || o.ignore
								? (!Q(e) &&
								  ...
								  r.push(0 === e.indexOf('mailto:') ? '' : '' !== c ? ' rel="' + c + '"' : ''))
				...
				})({ renderer: e, router: l, linkTarget: t, linkRel: n, compilerClass: c })),
				...
				(i.image = (function (e) {
					...
					return (t.image = function (e, t, n) {
						var r = e,
							...
							s = a.config;
						if (
							((t = o), s['no-zoom'] && i.push('data-no-zoom'), t && i.push('title="' + t + '"'), s.size)
						) {
									...
									a.push(r.substring(o, n - 1)),
										...
										a.push(
											(i && i[t]) ||
												function (e) {
													return (
														'00' + ('string' == typeof E[t] ? e[E[t]]() : E[t](e))
													).slice(-t.length);
												}
										);
								}),
	...
	function Et(e) {
		(e = e || '<h1>404 - Not found</h1>'),
			...
			!1 === this.config.executeScript || void 0 === window.Vue || St()
				? this.config.executeScript && St()
				: setTimeout(function (e) {
	...
	function Lt(e) {
		...
		t.mergeNavbar && f ? (o = y('.sidebar')) : (r.classList.add('app-nav'), t.repo || r.classList.add('no-badge')),
			t.loadNavbar && k(o, r),
			t.themeColor &&
				(u.head.appendChild(
					g(
	...
	(Rt.prototype.getBasePath = function () {
		...
		(Rt.prototype.getFile = function (e, t) {
			...
			return (
				(e =
					((e = (function (e, t) {
						return new RegExp('\\.(' + t.replace(/^\./, '') + '|html)$', 'g').test(e)
							? e
							: /\/$/g.test(e)
							? e + 'README' + t
							: '' + e + t;
	...
	function zt(e) {
		!(function (e) {
			...
			e.config.coverpage ? f || x('scroll', W) : v.classList.add('sticky');
	}
	function Pt(t, n, r, i, a, e) {
		(t = e ? t : t.replace(/\/$/, '')),
			(t = ee(t)) &&
				I(a.router.getFile(t + r) + n, !1, a.config.requestHeaders).then(i, function (e) {
					return Pt(t, n, r, i, a);
				});
	}
	...
	(Ut._init = function () {
		...
		(e.config = S(e)),
			...
			(function (t) {
				var e,
					n = t.config;
				(e = 'history' === (n.routerMode || 'hash') && i ? new $t(n) : new Ot(n)),
					(t.router = e),
					Nt(t),
					(Mt = t.route),
					e.onchange(function (e) {
						Nt(t),
							t._updateRender(),
							Mt.path !== t.route.path
								? (t.$fetch(p, t.$resetEvents.bind(t, e.source)), (Mt = t.route))
		...
		(Ut.route = {}),
		((Ht = Ut)._renderTo = function (e, t, n) {
			var r = m(e);
		...
		(Ht._renderMain = function (r, i, a) {
			...
			B(this, 'beforeEach', r, function (e) {
				function t() {
					i.updatedAt && (n = Tt(n, i.updatedAt, o.config.formatUpdated)),
				...
				o.isHTML
					? ((n = o.result = r), t(), a())
					: At({ compiler: o.compiler, raw: e }, function (e) {
		...
		(qt._fetch = function (n) {
			...
			(this.isRemoteUrl = (function (e) {
				var t = e.match(/^([^:\/?#]+:)?(?:\/\/([^\/?#]*))?([^?#]+)?(\?[^#]*)?(#.*)?/);
				return (
					('string' == typeof t[1] && 0 < t[1].length && t[1].toLowerCase() !== location.protocol) ||
					('string' == typeof t[2] &&
						0 < t[2].length &&
						t[2].replace(
				...
				return (
					o
						? ((o = this.router.getFile(a + o)),
						  ...
						  I(o + K(i, ['id']), !1, r).then(function (e) {
		...
		(qt._fetch404 = function (e, t, n) {
			...
			if (s) {
				...
				return (
					Bt(this.router.getFile(c), 0, o).then(
						function (e, t) {
		...
		(Ut.$resetEvents = function (e) {
			...
			'history' !== e &&
				(t.route.query.id && ye(t.route.path, t.route.query.id),
				'navigate' === e &&
					n &&
					(function (e) {
						void 0 === e && (e = 0), (be.scrollTop = !0 === e ? 0 : Number(e));
					})(n)),
				this.config.loadNavbar && G(this.router, 'nav');
		}),
		(window.Docsify = { util: jt, dom: t, get: I, slugify: ht, version: '4.11.4' }),
		(window.DocsifyCompiler = xt),
		(window.marked = ot),
		(window.Prism = vt),
		e(function (e) {
			return new Dt();
